...
impl U64x2 {
    ...
    /// use swario::*;
    ///
    /// assert_eq!(U64x2::MAX.to_array(), [18446744073709551615; 2]);
    ///
    /// ```
    ...
    /// use swario::*;
    ///
    /// assert_eq!(U64x2::MIN.to_array(), [0; 2]);
    ///
    /// ```
    ...
    /// use swario::*;
    ///
    /// assert_eq!(U64x2::LSB.to_array(), [0x0000000000000001; 2]);
    ///
    /// ```
    ...
    /// use swario::*;
    ///
    /// assert_eq!(U64x2::MSB.to_array(), [0x8000000000000000; 2]);
    ///
    /// ```
